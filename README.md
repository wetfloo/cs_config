...
| Serious Sam Classics (TFE/TSE) | `0.072`     | `800` | Player sensitivity set to 50%, mouse acceleration **ON**, smoothing **OFF**. Set using `inp_fMouseSensitivity` cvar |
| Devil Daggers                  | `0.058`     | `800` | Exact parameter value can be set by holding `Ctrl` and clicking on an option                                        |
| DUSK                           | `0.0565`    | `800` | Click on a value to set the exact one                                                                               |
